...
export async function GET(request, { params }) {
  try {
    ...
    const sql = `
      ...
      century.name as century_name, century.reference as century_reference
      FROM book
      ...
      left join book_century_l on book_century_l.book_id = book.cs_rid
      left join century on century.cs_rid = book_century_l.century_id
