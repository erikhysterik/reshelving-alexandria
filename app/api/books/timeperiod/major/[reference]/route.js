...
export async function GET(request, { params }) {
  try {
    ...
    const sql = `
      ...
      timeperiod.name as timeperiod_name, timeperiod.reference as timeperiod_reference, timeperiod.type as timeperiod_type
      FROM book
      ...
      AND timeperiod.reference = ? AND timeperiod.type = 'major'
    ...
    console.error('Error fetching books by major time period:', error)
