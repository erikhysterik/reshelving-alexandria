...
export default function PublishedDatePage({ params }) {
  ...
  React.useEffect(() => {
    const fetchBooks = async () => {
      try {
        const response = await fetch(`/api/books/published/${params.date}`)
          ...
          <Container>
              ...
              <Col>
                <Breadcrumb>
                  ...
                  <BreadcrumbItem active>
                    <Link href={`/legacy-library/books/published/${params.date}`}>Published {params.date}</Link>
                  </BreadcrumbItem>
                </Breadcrumb>
              </Col>
              <Col xs={2}>
            ...
            <Row className="justify-content-center">
              <Col lg="11" className="mb-4 mb-lg-5">
                <Box>
                  <Title variant="hero">Books Published in {params.date}</Title>
                </Box>
              </Col>
            </Row>
            <Row>
                  ...
                  <Table striped bordered hover size="sm" variant="dark">
                    ...
                    <tbody>
                      {loading ? (
                        ...
                        <tr>
                          <td colSpan="3" className="text-center">
                            No books found for {params.date}.
                          </td>
                        </tr>
                      ) : (
